...
<div class="card clearfix" style="margin-top: -50px;">
  <div class="header my-header">
     <h5 style="margin: 0;font-size: 18px;font-weight: normal;color: #111111c7;"><?php echo lang('updateIgniterAdmin'); ?> </h5>
  </div>
<div class="col-md-12">
<?php
if ($latest_version > $current_version) {?>
      <div class="col-md-6 text-center">
        <div class="alert alert-<?php if ($latest_version > $current_version) {echo 'danger';} else {echo 'info';}?>">
           ...
           <p class="font-medium bold" style="text-align: center;color: white;"><?php echo wordwrap($current_version, 1, '.', true); ?></p>
        </div>
     </div>
     <div class="col-md-6 text-center">
