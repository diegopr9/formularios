...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="../assets/images/logo_clr.png" />
                ...
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed Igniter Admin- Project</span>  
                                </div>
                        ...
                        <div class="text-center m-b-10">
                            Thanks for using <a href="http://igniteradmin.com/demo/index.php"> Igniter Admin</a>
                        </div>
